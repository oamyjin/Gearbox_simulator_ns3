...
namespace ns3 {
    ...
    TypeId Level_flex::GetTypeId(void)
    {
      static TypeId tid = TypeId("ns3::Level_flex")
    	    ...
    	    .AddAttribute ("H_value",
                   "H threshold of Pifo",
                   IntegerValue (40),
                   MakeIntegerAccessor (&Level_flex::H_value),
                   MakeIntegerChecker<int> ())
    	    .AddAttribute ("L_value",
                   "L threshold of Pifo",
                   IntegerValue (20),
                   MakeIntegerAccessor (&Level_flex::L_value),
                   MakeIntegerChecker<int> ())
            ;
        return tid;
    }
   ...
   int Level_flex::getFifoMaxNPackets(){
    ...
    void Level_flex::fifoPktPrint(int index){
	pifo.PktPrint();
    ...
    int Level_flex::addSchePkt(int uid, int departureRound){
	qpkts[uid] = departureRound;
	return qpkts.size();
    }

    int Level_flex::removeSchePkt(int uid){
    ...
    int Level_flex::cal_inversion_mag(int dp){
	int magnitude = 0;
