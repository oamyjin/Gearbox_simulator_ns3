...
int main(){
	...
	cout << "statistics "<<statis<<"fifoenque"<<fifoenque<<"fifodeque"<<fifodeque<<"pifoenque"<<pifoenque<<"pifodeque"<<pifodeque<<"overflow"<<overflow<<"reload"<<reload<<"migration"<<migration<<endl;
