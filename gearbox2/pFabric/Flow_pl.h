...
public:
    ...
    Flow_pl(string label, int no, float weight, uint32_t flowsize, int burstness); // 07102019 Peixuan: control flow burstness level
    ...
    int getFlowNo();
    void setRemaningSize(uint64_t remainingsize);
    uint64_t getRemaningSize();
