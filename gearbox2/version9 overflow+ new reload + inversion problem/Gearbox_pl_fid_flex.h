...
namespace ns3 {
	...
	int enque_previous, deque_previous, overflow_previous, reload_previous = 0;
	...
	int enquerate, dequerate, overflowrate, reloadrate;
	...
	*/
	...
	void Rate(int enqueCount, int dequeCount, int overflowCount, int reloadCount);
