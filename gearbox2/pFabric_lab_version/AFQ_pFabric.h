...
namespace ns3 {
    ...
    class AFQ_pFabric : public QueueDisc {

    private:

        static const int DEFAULT_VOLUME = 1; // number of levels
        static const int FIFO_PER_LEVEL = 20000;  // number of fifos per level
 	...
 	static const int SPEEDUP_FACTOR = 4; // default speed up
        static const int GRANULARITY = 1; // granularity per fifo
	...
	vector<string> Flowlist; 
        Level_afq_pFabric levels[DEFAULT_VOLUME]; // levels
