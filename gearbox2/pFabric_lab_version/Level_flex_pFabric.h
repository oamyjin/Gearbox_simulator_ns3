#ifndef Level_flex_pFabric_H

#define Level_flex_pFabric_H
...
namespace ns3 {
 ...
 class Level_flex_pFabric : public Object {

 private:

     static const int DEFAULT_VOLUME = 25; //number of fifos

     static const int FIFO_PER_LEVEL = 25;

     static const int DEFAULT_FIFO_N_SIZE = 20;

     static const int SPEEDUP_FACTOR = 4;

     static const int GRANULARITY = 800;
     ...
     int L_value = 5;    //low threshold of pifo
 ...
 public:
     ...
     Level_flex_pFabric(int vol, int index);
