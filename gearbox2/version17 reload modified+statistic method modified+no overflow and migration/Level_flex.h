...
namespace ns3 {
 ...
 private:
     ...
     static const int DEFAULT_FIFO_N_SIZE = 30;
     ...
     int reload, fifoenque, fifodeque = 0;
 ...
 //priority_queue <Map<int, QueueDiscItem*>> pifos;
     ...
     int H_value =30;    //high threshold of pifo

     int L_value =15;    //low threshold of pifo
 ...
 public:
	...
	// return queueItem if overflow, otherwise NULL
     ...
     QueueDiscItem*  pifoEnque(QueueDiscItem* item, int flowid);
