...
namespace ns3 {
	...
	int migrationCount=0;
        ...
        int dropCount = 0;
        int dropCountA = 0; // too large range
        int dropCountB = 0; // overflow
	...
	vector<uint64_t> Flowlist; 
        ...
        Level_flex levels[DEFAULT_VOLUME];
        ...
        Flow_pl* insertNewFlowPtr(uint64_t fid, int fno, int weight, int brustness);   // Peixuan 04212020
	...
	//bool PifoEnqueue(QueueDiscItem* item);
	...
	*/
	...
	//void ifCurrentFifoChange(int currentFifo);
